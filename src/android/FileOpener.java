...
public class FileOpener extends CordovaPlugin {
    ...
    private void openFile(String url) throws IOException {
        ...
        if (url.contains(".doc") || url.contains(".docx")) {
            ...
            // mobi file
            intent = new Intent(Intent.ACTION_VIEW);
            intent.setDataAndType(uri, "application/x-mobipocket-ebook");
        } else if (url.contains(".epub") || url.contains(".epub2") || url.contains(".epub3") || url.contains(".epub4")) {
            // epub file
            intent = new Intent(Intent.ACTION_VIEW);
        ...
        } else if(url.contains(".mpg") || url.contains(".mpeg") || url.contains(".mpe") || url.contains(".mp4") || url.contains(".m4v") || url.contains(".avi")) {
            // Video files
            intent = new Intent(Intent.ACTION_VIEW);
